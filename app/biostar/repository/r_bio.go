...
func GetUser() ([]getApiResponse, error) {
	...
	req.Header.Set("bs-session-id", "3bea411a90e54af7a83efeb02ae75c66")
...
func PostUser(post Users) (Users, error) {
	...
	req.Header.Set("bs-session-id", "93507c85508a461dbc36d5d73c090ea4")
...
func DeleteUser() error {
	...
	req.Header.Set("Content-Type", "application/json") // Set the content type
	req.Header.Set("bs-session-id", "643f64efb7114485a2fd89de17ca13fb")
...
func LoginAdmin(post Login) (Login, http.Header, error) {
	...
	if res.StatusCode != http.StatusOK {
		return Login{}, nil, fmt.Errorf("Login failed with status code: %s", res.Status)
	}
